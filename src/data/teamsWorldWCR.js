...
export const WORLDWCR_TEAMS_DATA = [
  { name: "Monster Energy Crescent Yamaha", nameTemplate: "{sponsor} Crescent Yamaha", logoId: "crescent_yamaha_wcr", tier: "Puntero", slots: 2, manufacturer: "Yamaha", color: "#9BEA83",
  ...
  { name: "Terra & Vita GRT Yamaha WorldWCR", nameTemplate: "{sponsor} GRT Yamaha WorldWCR", logoId: "grt_yamaha_wcr", tier: "Puntero", slots: 2, manufacturer: "Yamaha", color: "#0072CE",
  ...
  { name: "Klint Racing Team", nameTemplate: "{sponsor} Klint Racing Team", logoId: "klint_racing_wcr", tier: "Puntero", slots: 2, manufacturer: "Yamaha", color: "#6EDECA",
  ...
  { name: "GMT94-Yamaha", nameTemplate: "{sponsor} GMT94 Yamaha", logoId: "gmt94_yamaha_wcr", tier: "Satélite", slots: 2, manufacturer: "Yamaha", color: "#0072CE",
  ...
  { name: "MotosCerpa", nameTemplate: "{sponsor} MotosCerpa", logoId: "motoscerpa_wcr", tier: "Satélite", slots: 2, manufacturer: "Yamaha", color: "#FCFB52",
  ...
  { name: "Pons Italika Racing FIMLA", nameTemplate: "{sponsor} Italika Racing FIMLA", logoId: "italika_fimla_wcr", tier: "Satélite", slots: 2, manufacturer: "Yamaha", color: "#FE7636",
  ...
  { name: "PR46+1 Racing Team", nameTemplate: "{sponsor} PR46+1 Racing Team", logoId: "pr46_racing_wcr", tier: "Satélite", slots: 2, manufacturer: "Yamaha", color: "#D8D9D9",
  ...
  { name: "Hadden Racing Team", nameTemplate: "{sponsor} Hadden Racing Team", logoId: "hadden_racing_wcr", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#D83E23",
  ...
  { name: "DafitMotoracing", nameTemplate: "{sponsor} Dafitmotoracing", logoId: "dafitmotoracing_wcr", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#FD9290",
  ...
  { name: "Pata AG Motorsport Italia", nameTemplate: "{sponsor} Motorsport Italia", logoId: "pata_ag_italia_wcr", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#D8D9D9",
  ...
  { name: "Prata Motor Sport", nameTemplate: "{sponsor} Prata Motor Sport", logoId: "prata_motorsport_wcr", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#0C56E7",
  ...
  { name: "Team Trasimeno", nameTemplate: "{sponsor} Team Trasimeno", logoId: "team_trasimeno_wcr", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#D8D9D9",
  ...
  { name: "TSL-Racing", nameTemplate: "{sponsor} TSL-Racing", logoId: "tsl_racing_wcr", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#46A8FD",
  ...
  { name: "YVS Sabadell Diva Racing", nameTemplate: "{sponsor} Diva Racing", logoId: "yvs_sabadell_wcr", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#D7E45B",
  ...
  { name: "Yamaha AD78 FIMLA", nameTemplate: "{sponsor} AD78 FIMLA", logoId: "ad78_fimla_wcr", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#84B857",
  ...
  { name: "FT Racing Academy", nameTemplate: "{sponsor} FT Racing Academy", logoId: "ft_racing_academy_wcr", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#E4659E",
  ...
  { name: "Full Throttle Racing", nameTemplate: "{sponsor} Full Throttle Racing", logoId: "full_throttle_wcr", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#F02C7B",
