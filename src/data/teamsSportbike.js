...
export const SPORTBIKE_TEAMS_DATA = [
  ...
  { name: "Team Prodina Kawasaki XCI", nameTemplate: "{sponsor} Team Prodina Kawasaki XCI", logoId: "prodina_kawasaki_spb", tier: "Puntero", slots: 2, manufacturer: "Kawasaki", color: "#f8df3b",
    ...
    riders: [
      { name: "David Salvador", photoId: 160, nat: "🇪🇸", age: 22, potential: 78, tecnica: 69, ritmo: 68, adelantamientos: 66, mental: 64, adaptabilidad: 62, fisico: 61, number: 38 },
      { name: "Antonio Torres", photoId: 161, nat: "🇪🇸", age: 21, potential: 72, tecnica: 66, ritmo: 67, adelantamientos: 62, mental: 64, adaptabilidad: 59, fisico: 60, number: 47 },
    ] },
  ...
  { name: "MTM Kawasaki", nameTemplate: "{sponsor} MTM Kawasaki", logoId: "mtm_kawasaki_spb", tier: "Puntero", slots: 2, manufacturer: "Kawasaki", color: "#4CAF50",
    ...
    riders: [
      { name: "Xavier Artigas", photoId: 164, nat: "🇪🇸", age: 20, potential: 76, tecnica: 57, ritmo: 58, adelantamientos: 65, mental: 64, adaptabilidad: 60, fisico: 62, number: 34 },
      { name: "Loris Veneman", photoId: 165, nat: "🇳🇱", age: 19, potential: 76, tecnica: 57, ritmo: 55, adelantamientos: 59, mental: 60, adaptabilidad: 53, fisico: 52, number: 71 },
    ] },
  ...
  { name: "Revo–M2", nameTemplate: "{sponsor} Revo–M2", logoId: "revo_m2_spb", tier: "Satélite", slots: 2, manufacturer: "Aprilia", color: "#f9171f",
    ...
    riders: [
      { name: "Matteo Vannucci", photoId: 166, nat: "🇮🇹", age: 20, potential: 71, tecnica: 60, ritmo: 58, adelantamientos: 62, mental: 63, adaptabilidad: 56, fisico: 55, number: 91 },
      { name: "Mattia Sorrenti", photoId: 167, nat: "🇮🇹", age: 18, potential: 58, tecnica: 50, ritmo: 51, adelantamientos: 46, mental: 48, adaptabilidad: 43, fisico: 44, number: 11 },
    ] },
  { name: "CM Triumph Factory Racing", nameTemplate: "{sponsor} CM Triumph Factory Racing", logoId: "cm_triumph_spb", tier: "Satélite", slots: 2, manufacturer: "Triumph", color: "#e1ff4f",
    ...
    riders: [
      { name: "Bruno Ieraci", photoId: 168, nat: "🇮🇹", age: 24, potential: 64, tecnica: 62, ritmo: 63, adelantamientos: 58, mental: 60, adaptabilidad: 55, fisico: 56, number: 18 },
  ...
  { name: "Team BrCorse", nameTemplate: "{sponsor} Team BrCorse", logoId: "brcorse_spb", tier: "Satélite", slots: 2, manufacturer: "Yamaha", color: "#003DA5",
    ...
    riders: [
      { name: "Carter Thompson", photoId: 170, nat: "🇦🇺", age: 18, potential: 72, tecnica: 62, ritmo: 61, adelantamientos: 59, mental: 57, adaptabilidad: 55, fisico: 54, number: 50 },
  ...
  { name: "PHR Performance Triumph", nameTemplate: "{sponsor} PHR Performance Triumph", logoId: "phr_triumph_spb", tier: "Satélite", slots: 2, manufacturer: "Triumph", color: "#e1ff4f",
    ...
    riders: [
      { name: "Harrison Dessoy", photoId: 172, nat: "🇬🇧", age: 20, potential: 61, tecnica: 55, ritmo: 56, adelantamientos: 51, mental: 53, adaptabilidad: 48, fisico: 49, number: 55 },
      { name: "Fenton Seabright", photoId: 173, nat: "🇬🇧", age: 19, potential: 65, tecnica: 51, ritmo: 52, adelantamientos: 59, mental: 58, adaptabilidad: 54, fisico: 56, number: 73 },
    ] },
  { name: "Deza–Box 77 Racing Team", nameTemplate: "{sponsor} Deza–Box 77 Racing Team", logoId: "deza_box77_spb", tier: "Satélite", slots: 2, manufacturer: "Kawasaki", color: "#4CAF50",
    ...
    riders: [
      { name: "Álvaro Fuertes", photoId: 174, nat: "🇪🇸", age: 18, potential: 63, tecnica: 58, ritmo: 57, adelantamientos: 55, mental: 53, adaptabilidad: 51, fisico: 50, number: 16 },
      { name: "José Osuna", photoId: 175, nat: "🇪🇸", age: 19, potential: 57, tecnica: 50, ritmo: 48, adelantamientos: 52, mental: 53, adaptabilidad: 46, fisico: 45, number: 77 },
    ] },
  { name: "VLR Racing Team Suzuki", nameTemplate: "{sponsor} VLR Racing Team Suzuki", logoId: "vlr_suzuki_spb", tier: "Satélite", slots: 2, manufacturer: "Suzuki", color: "#0033A0",
    ...
    riders: [
      ...
      { name: "Filippo Bianchi", photoId: 177, nat: "🇮🇹", age: 18, potential: 58, tecnica: 46, ritmo: 47, adelantamientos: 54, mental: 53, adaptabilidad: 49, fisico: 51, number: 25 },
    ] },
  ...
  { name: "ProGP NitiRacing", nameTemplate: "{sponsor} ProGP NitiRacing", logoId: "progp_nitiracing_spb", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#2cb8de",
    ...
    riders: [
      { name: "Felix Mulya", photoId: 180, nat: "🇮🇩", age: 19, potential: 52, tecnica: 42, ritmo: 43, adelantamientos: 50, mental: 49, adaptabilidad: 45, fisico: 47, number: 27 },
      { name: "Arai Agaska", photoId: 181, nat: "🇮🇩", age: 18, potential: 45, tecnica: 42, ritmo: 40, adelantamientos: 44, mental: 45, adaptabilidad: 38, fisico: 37, number: 93 },
    ] },
  { name: "ARCO Yamaha MotoR University Team", nameTemplate: "{sponsor} Yamaha MotoR University Team", logoId: "arco_yamaha_spb", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#003DA5",
    ...
    riders: [
      { name: "Alessandro Di Persio", photoId: 182, nat: "🇮🇹", age: 20, potential: 52, tecnica: 47, ritmo: 45, adelantamientos: 49, mental: 50, adaptabilidad: 43, fisico: 42, number: 69 },
      { name: "Gonzalo Sánchez", photoId: 183, nat: "🇪🇸", age: 18, potential: 49, tecnica: 45, ritmo: 43, adelantamientos: 47, mental: 48, adaptabilidad: 41, fisico: 40, number: 33 },
    ] },
  { name: "Panattoni BGR Smrz Racing", nameTemplate: "{sponsor} BGR Smrz Racing", logoId: "panattoni_bgr_smrz_spb", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#244bd7",
    ...
    riders: [
      { name: "Mirko Gennai", photoId: 184, nat: "🇮🇹", age: 21, potential: 52, tecnica: 51, ritmo: 50, adelantamientos: 48, mental: 46, adaptabilidad: 44, fisico: 43, number: 26 },
      { name: "Troy Sovička", photoId: 185, nat: "🇨🇿", age: 19, potential: 43, tecnica: 43, ritmo: 42, adelantamientos: 40, mental: 38, adaptabilidad: 36, fisico: 35, number: 21 },
    ] },
  { name: "Pons Motosport Italika Racing", nameTemplate: "{sponsor} Pons Motosport Italika Racing", logoId: "pons_italika_spb", tier: "Independiente", slots: 2, manufacturer: "Kawasaki", color: "#2545e2",
    ...
    riders: [
      { name: "Juan Risueño", photoId: 186, nat: "🇪🇸", age: 18, potential: 50, tecnica: 48, ritmo: 49, adelantamientos: 44, mental: 46, adaptabilidad: 41, fisico: 42, number: 39 },
      { name: "Julian Correa", photoId: 187, nat: "🇺🇸", age: 19, potential: 50, tecnica: 41, ritmo: 42, adelantamientos: 49, mental: 48, adaptabilidad: 44, fisico: 46, number: 40 },
    ] },
  { name: "MMR", nameTemplate: "{sponsor} MMR", logoId: "mmr_spb", tier: "Independiente", slots: 2, manufacturer: "Aprilia", color: "#f36e49",
    ...
    riders: [
      { name: "Thomas Benetti", photoId: 188, nat: "🇮🇹", age: 19, potential: 50, tecnica: 49, ritmo: 48, adelantamientos: 46, mental: 44, adaptabilidad: 42, fisico: 41, number: 98 },
      { name: "Ioannis Peristeras", photoId: 189, nat: "🇬🇷", age: 20, potential: 43, tecnica: 36, ritmo: 37, adelantamientos: 44, mental: 43, adaptabilidad: 39, fisico: 41, number: 41 },
    ] },
  { name: "Yamaha AD78 FIMLA by MS Racing", nameTemplate: "{sponsor} Yamaha AD78 FIMLA by MS Racing", logoId: "yamaha_ad78_fimla_spb", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#003DA5",
    ...
    riders: [
      { name: "Gabin Cazard", photoId: 190, nat: "🇫🇷", age: 18, potential: 41, tecnica: 39, ritmo: 37, adelantamientos: 41, mental: 42, adaptabilidad: 35, fisico: 34, number: 92 },
      { name: "Humberto Maier", photoId: 191, nat: "🇧🇷", age: 20, potential: 48, tecnica: 48, ritmo: 47, adelantamientos: 45, mental: 43, adaptabilidad: 41, fisico: 40, number: 12 },
    ] },
  { name: "PATA AG Motorsport Italia", nameTemplate: "{sponsor} AG Motorsport Italia", logoId: "pata_ag_motorsport_spb", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#e53623",
    ...
    riders: [
      { name: "Taiyo Aksu", photoId: 192, nat: "🇦🇺", age: 17, potential: 50, tecnica: 38, ritmo: 39, adelantamientos: 46, mental: 45, adaptabilidad: 41, fisico: 43, number: 89 },
      { name: "Diego Poncet", photoId: 193, nat: "🇫🇷", age: 18, potential: 55, tecnica: 50, ritmo: 51, adelantamientos: 46, mental: 48, adaptabilidad: 43, fisico: 44, number: 36 },
    ] },
  { name: "Miguel Oliveira Team", nameTemplate: "{sponsor} Miguel Oliveira Team", logoId: "miguel_oliveira_team_spb", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#feff44",
    ...
    riders: [
      { name: "Tomás Alonso", photoId: 194, nat: "🇵🇹", age: 18, potential: 46, tecnica: 44, ritmo: 43, adelantamientos: 41, mental: 39, adaptabilidad: 37, fisico: 36, number: 79 },
      { name: "Carl Harris", photoId: 195, nat: "🇬🇧", age: 17, potential: 42, tecnica: 41, ritmo: 42, adelantamientos: 37, mental: 39, adaptabilidad: 34, fisico: 35, number: 9 },
    ] },
];
