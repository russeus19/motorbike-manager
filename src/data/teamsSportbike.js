...
export const SPORTBIKE_TEAMS_DATA = [
  ...
  { name: "Team Prodina Kawasaki XCI", logoId: "prodina_kawasaki_spb", tier: "Puntero", slots: 2, manufacturer: "Kawasaki", color: "#4CAF50",
  ...
  { name: "Track & Trades Wixx Racing", logoId: "trackandtrades_wixx_spb", tier: "Puntero", slots: 2, manufacturer: "Suzuki", color: "#0033A0",
  ...
  { name: "MTM Kawasaki", logoId: "mtm_kawasaki_spb", tier: "Puntero", slots: 2, manufacturer: "Kawasaki", color: "#4CAF50",
  ...
  { name: "Revo–M2", logoId: "revo_m2_spb", tier: "Satélite", slots: 2, manufacturer: "Aprilia", color: "#000000",
  ...
  { name: "CM Triumph Factory Racing", logoId: "cm_triumph_spb", tier: "Satélite", slots: 2, manufacturer: "Triumph", color: "#001A2C",
  ...
  { name: "Team BrCorse", logoId: "brcorse_spb", tier: "Satélite", slots: 2, manufacturer: "Yamaha", color: "#003DA5",
  ...
  { name: "PHR Performance Triumph", logoId: "phr_triumph_spb", tier: "Satélite", slots: 2, manufacturer: "Triumph", color: "#001A2C",
  ...
  { name: "Deza–Box 77 Racing Team", logoId: "deza_box77_spb", tier: "Satélite", slots: 2, manufacturer: "Kawasaki", color: "#4CAF50",
  ...
  { name: "VLR Racing Team Suzuki", logoId: "vlr_suzuki_spb", tier: "Satélite", slots: 2, manufacturer: "Suzuki", color: "#0033A0",
  ...
  // --- Independiente (resto) ---
  { name: "Kove Racing Team 109", logoId: "kove_racing109_spb", tier: "Independiente", slots: 2, manufacturer: "Kove", color: "#FF7A00",
  ...
  { name: "ProGP NitiRacing", logoId: "progp_nitiracing_spb", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#DA291C",
  ...
  { name: "ARCO Yamaha MotoR University Team", logoId: "arco_yamaha_spb", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#003DA5",
  ...
  { name: "Panattoni BGR Smrz Racing", logoId: "panattoni_bgr_smrz_spb", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#7A7A7A",
  ...
  { name: "Pons Motosport Italika Racing", logoId: "pons_italika_spb", tier: "Independiente", slots: 2, manufacturer: "Kawasaki", color: "#4CAF50",
  ...
  { name: "MMR", logoId: "mmr_spb", tier: "Independiente", slots: 2, manufacturer: "Aprilia", color: "#000000",
  ...
  { name: "Yamaha AD78 FIMLA by MS Racing", logoId: "yamaha_ad78_fimla_spb", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#003DA5",
  ...
  { name: "PATA AG Motorsport Italia", logoId: "pata_ag_motorsport_spb", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#003DA5",
  ...
  { name: "Miguel Oliveira Team", logoId: "miguel_oliveira_team_spb", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#003DA5",
