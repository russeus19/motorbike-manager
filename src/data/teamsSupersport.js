...
export const SUPERSPORT_TEAMS_DATA = [
  { name: "AS bLU cRU Racing Team", logoId: "as_blucru_wssp", tier: "Fábrica", slots: 2, manufacturer: "Yamaha", color: "#2d3faa",
    ...
    riders: [
      { name: "Albert Arenas", photoId: 150, nat: "🇪🇸", age: 27, potential: 55, tecnica: 82, ritmo: 81, adelantamientos: 80, mental: 79, adaptabilidad: 76, fisico: 74, number: 75 },
      { name: "Aldi Satya Mahendra", photoId: 149, nat: "🇮🇩", age: 24, potential: 62, tecnica: 74, ritmo: 73, adelantamientos: 74, mental: 66, adaptabilidad: 68, fisico: 72, number: 57 },
    ] },
  { name: "Orelac Racing Verdnatura", logoId: "orelac_wssp", tier: "Fábrica", slots: 2, manufacturer: "Ducati", color: "#960a0e",
    bike: { aero: 84, chasis: 83, motor: 83, freno: 82, electronica: 83 }, budget: 900000,
    riders: [
      { name: "Jaume Masià", photoId: 133, nat: "🇪🇸", age: 24, potential: 60, tecnica: 81, ritmo: 80, adelantamientos: 79, mental: 74, adaptabilidad: 72, fisico: 71, number: 5 },
      { name: "Joshua Whatley", photoId: 134, nat: "🇬🇧", age: 21, potential: 68, tecnica: 63, ritmo: 62, adelantamientos: 62, mental: 55, adaptabilidad: 58, fisico: 66, number: 70 },
    ] },
  { name: "Zxmoto Factory Evan Bros Racing", logoId: "zxmoto_evanbros_wssp", tier: "Fábrica", slots: 2, manufacturer: "Zxmoto", color: "#1c1c1c",
    bike: { aero: 82, chasis: 81, motor: 80, freno: 80, electronica: 81 }, budget: 880000,
    riders: [
      { name: "Valentin Debise", photoId: 158, nat: "🇫🇷", age: 30, potential: 45, tecnica: 79, ritmo: 78, adelantamientos: 77, mental: 74, adaptabilidad: 71, fisico: 68, number: 53 },
      { name: "Federico Caricasulo", photoId: 159, nat: "🇮🇹", age: 30, potential: 40, tecnica: 71, ritmo: 68, adelantamientos: 67, mental: 65, adaptabilidad: 64, fisico: 65, number: 64 },
    ] },
  { name: "GMT94 Yamaha", logoId: "gmt94_yamaha_wssp", tier: "Satélite", slots: 2, manufacturer: "Yamaha", color: "#2d3faa",
    ...
    riders: [
      { name: "Roberto García", photoId: 152, nat: "🇪🇸", age: 29, potential: 42, tecnica: 74, ritmo: 72, adelantamientos: 71, mental: 68, adaptabilidad: 66, fisico: 68, number: 37 },
      { name: "Lucas Mahias", photoId: 153, nat: "🇫🇷", age: 35, potential: 25, tecnica: 76, ritmo: 71, adelantamientos: 69, mental: 73, adaptabilidad: 68, fisico: 60, number: 94 },
    ] },
  { name: "Pata Yamaha Ten Kate Racing", logoId: "pata_tenkate_wssp", tier: "Satélite", slots: 2, manufacturer: "Yamaha", color: "#2d3faa",
    ...
    riders: [
      { name: "Can Öncü", photoId: 156, nat: "🇹🇷", age: 21, potential: 66, tecnica: 68, ritmo: 70, adelantamientos: 71, mental: 60, adaptabilidad: 64, fisico: 67, number: 61 },
      { name: "Yuki Okamoto", photoId: 155, nat: "🇯🇵", age: 24, potential: 48, tecnica: 63, ritmo: 61, adelantamientos: 61, mental: 56, adaptabilidad: 58, fisico: 64, number: 31 },
    ] },
  { name: "PTR Triumph Factory Racing", logoId: "ptr_triumph_wssp", tier: "Fábrica", slots: 2, manufacturer: "Triumph", color: "#0a3161",
    bike: { aero: 80, chasis: 79, motor: 79, freno: 78, electronica: 79 }, budget: 820000,
    riders: [
      { name: "Oli Bayliss", photoId: 147, nat: "🇦🇺", age: 21, potential: 65, tecnica: 71, ritmo: 74, adelantamientos: 72, mental: 61, adaptabilidad: 63, fisico: 70, number: 32 },
      { name: "Tom Booth-Amos", photoId: 148, nat: "🇬🇧", age: 24, potential: 58, tecnica: 70, ritmo: 71, adelantamientos: 70, mental: 62, adaptabilidad: 63, fisico: 69, number: 69 },
    ] },
  { name: "Feel Racing WorldSSP Team", logoId: "feel_racing_wssp", tier: "Satélite", slots: 2, manufacturer: "Ducati", color: "#960a0e",
    ...
    riders: [
      { name: "Philipp Öttl", photoId: 132, nat: "🇩🇪", age: 30, potential: 40, tecnica: 75, ritmo: 73, adelantamientos: 71, mental: 70, adaptabilidad: 68, fisico: 65, number: 65 },
    ] },
  { name: "Kawasaki WorldSSP Team", logoId: "kawasaki_wssp_indep", tier: "Independiente", slots: 2, manufacturer: "Kawasaki", color: "#57ce3c",
    ...
    riders: [
      { name: "Jeremy Alcoba", photoId: 140, nat: "🇪🇸", age: 25, potential: 55, tecnica: 70, ritmo: 69, adelantamientos: 68, mental: 63, adaptabilidad: 64, fisico: 67, number: 52 },
      { name: "Dominique Aegerter", photoId: 141, nat: "🇨🇭", age: 35, potential: 20, tecnica: 73, ritmo: 68, adelantamientos: 65, mental: 74, adaptabilidad: 68, fisico: 58, number: 77 },
    ] },
  { name: "WRP Racing", logoId: "wrp_racing_wssp", tier: "Independiente", slots: 2, manufacturer: "Ducati", color: "#960a0e",
    ...
    riders: [
      { name: "Matteo Ferrari", photoId: 136, nat: "🇮🇹", age: 28, potential: 44, tecnica: 69, ritmo: 68, adelantamientos: 66, mental: 63, adaptabilidad: 63, fisico: 65, number: 11 },
  ...
  { name: "Ecosantagata Althea Racing Team", logoId: "ecosantagata_althea_wssp", tier: "Independiente", slots: 2, manufacturer: "Ducati", color: "#960a0e",
    ...
    riders: [
      { name: "Alessandro Zaccone", photoId: 131, nat: "🇮🇹", age: 29, potential: 42, tecnica: 68, ritmo: 66, adelantamientos: 66, mental: 64, adaptabilidad: 62, fisico: 63, number: 16 },
  ...
  { name: "EAB Racing Team", logoId: "eab_racing_wssp", tier: "Independiente", slots: 2, manufacturer: "Ducati", color: "#960a0e",
    ...
    riders: [
      { name: "Simon Jespersen", photoId: 129, nat: "🇩🇰", age: 21, potential: 58, tecnica: 58, ritmo: 57, adelantamientos: 57, mental: 51, adaptabilidad: 54, fisico: 62, number: 43 },
    ] },
  { name: "VFT Racing Yamaha", logoId: "vft_racing_wssp", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#2d3faa",
    ...
    riders: [
      { name: "Filippo Farioli", photoId: 157, nat: "🇮🇹", age: 24, potential: 46, tecnica: 60, ritmo: 59, adelantamientos: 58, mental: 53, adaptabilidad: 55, fisico: 61, number: 7 },
    ] },
  { name: "D34G WorldSSP Racing Team", logoId: "d34g_wssp", tier: "Independiente", slots: 2, manufacturer: "Ducati", color: "#960a0e",
    ...
    riders: [
      { name: "Mattia Casadei", photoId: 128, nat: "🇮🇹", age: 32, potential: 30, tecnica: 66, ritmo: 62, adelantamientos: 60, mental: 65, adaptabilidad: 61, fisico: 58, number: 40 },
    ] },
  { name: "Compos Racing Team", logoId: "compos_racing_wssp", tier: "Independiente", slots: 2, manufacturer: "Triumph", color: "#0a3161",
    ...
    riders: [
      ...
      { name: "Ondřej Vostatek", photoId: 146, nat: "🇨🇿", age: 27, potential: 34, tecnica: 60, ritmo: 58, adelantamientos: 56, mental: 55, adaptabilidad: 54, fisico: 59, number: 50 },
    ] },
  { name: "Honda Racing WorldSSP Team", logoId: "honda_racing_wssp", tier: "Independiente", slots: 2, manufacturer: "Honda", color: "#de2929",
    ...
    riders: [
      ...
      { name: "Corentin Perolari", photoId: 138, nat: "🇫🇷", age: 29, potential: 30, tecnica: 61, ritmo: 58, adelantamientos: 57, mental: 58, adaptabilidad: 56, fisico: 57, number: 6 },
    ] },
  { name: "Motozoo by Madforce Dubai", logoId: "motozoo_madforce_wssp", tier: "Independiente", slots: 2, manufacturer: "MV Agusta", color: "#b5121b",
    ...
    riders: [
      { name: "Andrea Giombini", photoId: 143, nat: "🇮🇹", age: 24, potential: 32, tecnica: 55, ritmo: 52, adelantamientos: 51, mental: 50, adaptabilidad: 51, fisico: 58, number: 88 },
    ] },
  { name: "Cerba Yamaha Racing Team", logoId: "cerba_yamaha_wssp", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#2d3faa",
    ...
    riders: [
      { name: "Xavier Cardelús", photoId: 151, nat: "🇪🇸", age: 24, potential: 30, tecnica: 53, ritmo: 51, adelantamientos: 50, mental: 49, adaptabilidad: 50, fisico: 57, number: 20 },
    ] },
  { name: "QJMotor Factory Racing", logoId: "qjmotor_factory_wssp", tier: "Independiente", slots: 2, manufacturer: "QJ Motor", color: "#c9a13b",
    bike: { aero: 63, chasis: 62, motor: 62, freno: 61, electronica: 62 }, budget: 440000,
    riders: [
      { name: "Marcos Ramírez", photoId: 91, nat: "🇪🇸", age: 27, potential: 52, tecnica: 71, ritmo: 71, adelantamientos: 69, mental: 67, adaptabilidad: 69, fisico: 67, number: 24 },
