...
export const SUPERSPORT_TEAMS_DATA = [
  { name: "AS bLU cRU Racing Team", nameTemplate: "AS {sponsor} Racing Team", logoId: "as_blucru_wssp", tier: "Fábrica", slots: 2, manufacturer: "Yamaha", color: "#2d3faa",
  ...
  { name: "Orelac Racing Verdnatura", nameTemplate: "Orelac Racing {sponsor}", logoId: "orelac_wssp", tier: "Fábrica", slots: 2, manufacturer: "Ducati", color: "#67696d",
  ...
  { name: "Zxmoto Factory Evan Bros Racing", nameTemplate: "{sponsor} Evan Bros Racing", logoId: "zxmoto_evanbros_wssp", tier: "Fábrica", slots: 2, manufacturer: "Zxmoto", color: "#bf0f00",
  ...
  { name: "GMT94 Yamaha", nameTemplate: "{sponsor} GMT94 Yamaha", logoId: "gmt94_yamaha_wssp", tier: "Satélite", slots: 2, manufacturer: "Yamaha", color: "#2d3faa",
  ...
  { name: "Pata Yamaha Ten Kate Racing", nameTemplate: "{sponsor} Yamaha Ten Kate Racing", logoId: "pata_tenkate_wssp", tier: "Satélite", slots: 2, manufacturer: "Yamaha", color: "#2d3faa",
  ...
  { name: "PTR Triumph Factory Racing", nameTemplate: "{sponsor} PTR Triumph Factory Racing", logoId: "ptr_triumph_wssp", tier: "Fábrica", slots: 2, manufacturer: "Triumph", color: "#faff26",
  ...
  { name: "Feel Racing WorldSSP Team", nameTemplate: "{sponsor} Feel Racing WorldSSP Team", logoId: "feel_racing_wssp", tier: "Satélite", slots: 2, manufacturer: "Ducati", color: "#960a0e",
  ...
  { name: "Kawasaki WorldSSP Team", nameTemplate: "{sponsor} Kawasaki WorldSSP Team", logoId: "kawasaki_wssp_indep", tier: "Independiente", slots: 2, manufacturer: "Kawasaki", color: "#57ce3c",
  ...
  { name: "WRP Racing", nameTemplate: "{sponsor} WRP Racing", logoId: "wrp_racing_wssp", tier: "Independiente", slots: 2, manufacturer: "Ducati", color: "#960a0e",
  ...
  { name: "Ecosantagata Althea Racing Team", nameTemplate: "{sponsor} Althea Racing Team", logoId: "ecosantagata_althea_wssp", tier: "Independiente", slots: 2, manufacturer: "Ducati", color: "#960a0e",
  ...
  { name: "EAB Racing Team", nameTemplate: "{sponsor} EAB Racing Team", logoId: "eab_racing_wssp", tier: "Independiente", slots: 2, manufacturer: "Ducati", color: "#960a0e",
  ...
  { name: "VFT Racing Yamaha", nameTemplate: "{sponsor} VFT Racing Yamaha", logoId: "vft_racing_wssp", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#2d3faa",
  ...
  { name: "D34G WorldSSP Racing Team", nameTemplate: "{sponsor} D34G WorldSSP Racing Team", logoId: "d34g_wssp", tier: "Independiente", slots: 2, manufacturer: "Ducati", color: "#960a0e",
  ...
  { name: "Compos Racing Team", nameTemplate: "{sponsor} Compos Racing Team", logoId: "compos_racing_wssp", tier: "Independiente", slots: 2, manufacturer: "Triumph", color: "#ff4b6b",
  ...
  { name: "Honda Racing WorldSSP Team", nameTemplate: "{sponsor} Honda Racing WorldSSP Team", logoId: "honda_racing_wssp", tier: "Independiente", slots: 2, manufacturer: "Honda", color: "#de2929",
    bike: { aero: 67, chasis: 66, motor: 66, freno: 65, electronica: 66 }, budget: 520000,
    riders: [
      { name: "Ana Carrasco", photoId: 139, nat: "🇪🇸", age: 29, gender: "F", potential: 63, tecnica: 60, ritmo: 70, adelantamientos: 61, mental: 60, adaptabilidad: 58, fisico: 57, number: 22 },
  ...
  { name: "Motozoo by Madforce Dubai", nameTemplate: "{sponsor} by Madforce Dubai", logoId: "motozoo_madforce_wssp", tier: "Independiente", slots: 2, manufacturer: "MV Agusta", color: "#b5121b",
  ...
  { name: "Cerba Yamaha Racing Team", nameTemplate: "{sponsor} Yamaha Racing Team", logoId: "cerba_yamaha_wssp", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#2d3faa",
  ...
  { name: "QJMotor Factory Racing", nameTemplate: "{sponsor} QJMotor Factory Racing", logoId: "qjmotor_factory_wssp", tier: "Independiente", slots: 2, manufacturer: "QJ Motor", color: "#9d180e",
  ...
  { name: "Flembbo by Racing Development", nameTemplate: "{sponsor} Flembbo by Racing Development", logoId: "flembbo_racingdev_wssp", tier: "Independiente", slots: 2, manufacturer: "MV Agusta", color: "#b5121b",
  ...
  { name: "Motorsport Kofler", nameTemplate: "{sponsor} Motorsport Kofler", logoId: "motorsport_kofler_wssp", tier: "Independiente", slots: 2, manufacturer: "Yamaha", color: "#2d3faa",
  ...
  { name: "Renzi Corse", nameTemplate: "{sponsor} Renzi Corse", logoId: "renzi_corse_wssp", tier: "Independiente", slots: 2, manufacturer: "Ducati", color: "#960a0e",
