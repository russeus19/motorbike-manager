...
export const INITIAL_SPONSORS_BY_CATEGORY = {
  motogp: {
    ...
    "Trackhouse MotoGP Team": { main: { name: "Superfile", shortTerm: true }, secondary: null },
    ...
    "Honda LCR": { main: null, secondary: "God55 Sports" },
  ...
  moto2: {
    ...
    "Reds Racing": { main: "Fantic", secondary: "Pallex" },
  ...
  superbikes: {
    ...
    "Barni Spark Racing Team": { main: "Spark", secondary: "Bardahl" },
    ...
    "GYTR GRT Yamaha WorldSBK Team": { main: "GYTR", secondary: "Pata" },
  ...
  supersport: {
    "AS bLU cRU Racing Team": { main: "Blu Cru", secondary: null },
    "Orelac Racing Verdnatura": { main: "Verdnatura", secondary: null },
    "Zxmoto Factory Evan Bros Racing": { main: "Zxmoto Factory", secondary: null },
    ...
    "Ecosantagata Althea Racing Team": { main: "Ecosantagata", secondary: null },
    "EAB Racing Team": { main: null, secondary: null },
    "VFT Racing Yamaha": { main: null, secondary: "Menghi" },
    "D34G WorldSSP Racing Team": { main: "Biblion", secondary: "Organica" },
    "Compos Racing Team": { main: null, secondary: null },
